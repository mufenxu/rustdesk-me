...
lazy_static::lazy_static! {
    pub static ref ORG: RwLock<String> = RwLock::new("com.greatwall".to_owned());
}
...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("GreatWallRemote".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["156.225.24.199"];
pub const RS_PUB_KEY: &str = "BsZXJbMKdR2NZLysy7Bpd9TlPNsoIjMmLaWo2LK2Bh0=";
