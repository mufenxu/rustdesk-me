...
import 'package:gw_remote/mobile/pages/settings_page.dart';
...
class ServerModel with ChangeNotifier {
  ...
  toggleService() async {
    if (_isStart) {
      ...
      // Keep screen capture startup lean: floating window and file transfer
      // are optional features with separate permission entry points.
      final res = await parent.target?.dialogManager
          .show<bool>((setState, close, context) {
        submit() => close(true);
        return CustomAlertDialog(
